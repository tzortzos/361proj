...
class TestCourse(TestCase):
    ...
    def test_get_course(self):
        course1 = Course.objects.create(course_code=self.course_code1,course_name=self.course_name1,admin_id=self.user1)
        course2 = CourseAPI.get_course_by_course_code(self.course_code1)
        self.assertEqual(course1, course2, msg="Expected the course to be retrieved by its course code.")

    def test_get_course_not_in_database(self):
