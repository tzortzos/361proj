...
class TestUser(TestCase):
    ...
    def setUp(self):
        ...
        self.user_id1 = UserAPI.create_user(UserType.ADMIN, self.univ_id1, self.lname1, self.fname1,
                                            self.phone1, self.password1)
    ...
    def test_delete_user(self):
        ...
        with self.assertRaises(LookupError, msg='Because we expect that the object is not in database.'):
            user = UserAPI.get_user_by_user_id(self.user_id1)
