...
class TestCourse(TestCase):
    ...
    def setUp(self):
        ...
        self.course2 = Course.objects.create(course_code=self.course_code2,course_name=self.course_name2,admin_id=self.user1)
