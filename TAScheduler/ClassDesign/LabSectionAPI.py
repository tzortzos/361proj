...
class LabSectionAPI:
    ...
    def get_lab_section_by_lab_id(lab: int) -> Optional[Lab]:
        ...
        """
        return Lab.objects.get(lab_section_id=lab)

    @staticmethod
    def get_all_lab_sections_from_course_section_and_course(course_section_id: int) -> List[Lab]:
        """
        Returns all LabSection objects associated with a specific course section id, if any exist
        """
        return Lab.objects.filter(course_section_id=course_section_id)
    ...
    def edit_lab_section(
        ...
        """
        lab = Lab.objects.get(lab_section_id=lab_section)
        lab.day = lab_days
        lab.time = lab_time
        lab.ta = ta_id
        lab.save()
    ...
    def delete_lab_section(
        ...
        """
        Lab.objects.get(lab_section_id=lab_section).delete()
